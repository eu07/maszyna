...
int XCoord, YCoord;           // Mouse Coordinates
  ...
  case WM_MOUSEMOVE:
  {
   ...
   return 0; // jump back
        ...
        case WM_LBUTTONDOWN :
        {
         ...
         World.OnMouseLpush(XCoord, YCoord);
         //LM_RetrieveObjectID(mouse.x, mouse.y);
         return 0;
        };
        ...
        case WM_RBUTTONDOWN :
        {
         ...
         World.OnMouseRpush(XCoord, YCoord);
         //RM_RetrieveObjectID(LOWORD(lParam), HIWORD(lParam));
         return 0;
        };
        ...
        case WM_MBUTTONDOWN :
        {
         ...
         World.OnMouseMpush(XCoord, YCoord);
         return 0;
        };
      ...
      while (!Parser->EndOfFile)
          {
              ...
              if (str==AnsiString("-v"))
               ...
               Error("Program usage: EU07 [-s sceneryfilepath] [-v vehiclename]",!Global::bWriteLogEnabled);     //!Global::bWriteLogEnabled
          }
