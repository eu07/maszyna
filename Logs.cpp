...
/*  WYLACZONE BO ZROBIONO NOWY LOADER NA OPENGLU
  if (Global::bLoaded == false) Form2->RELOG->Lines->Add(str);

  if (Form2->RELOG->Lines->Count > 15)
      {
       Form2->RELOG->Lines->Delete(0);
      }
       Form2->LLOG->Caption = Form2->RELOG->Text;
       //Form2->LLOG->Update();

       Form2->Update();

       if (Global::bLoaded == false) _progressmax();
  */
