...
AnsiString Global::asVersion="Compilation 2011-07-17, release 1.3.158.181."; //tutaj, bo wysy³any
...
bool Global::bConvertModels=true; //tworzenie plików binarnych
...
// ShaXbee - domyslne rozszerzenie tekstur
        ...
        {fMoveLight=Parser->GetNextSymbol().ToIntDef(-1); //numer dnia 1..365
         ...
         bConvertModels=(Parser->GetNextSymbol().LowerCase()==AnsiString("yes"));
    }
