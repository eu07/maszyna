...
//TODO: poprawic zeby dzialalo
    ...
    SaveToBinaryFile(Model->ostream);
...
//      return false;
    ...
    binaryFileName.replace(binaryFileName.rfind('.'), 4, ".b3d");
    ostream = std::ostream(binaryFileName, std::ios::binary | std::ios::trunc);

    BinaryWriter writer(ostream);
