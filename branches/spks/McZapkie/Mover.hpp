...
typedef TCoupling *PCouplers;

typedef Byte TCouplerNr[2];

#pragma option push -b-
enum TBrakeSystem { Individual, Pneumatic, ElectroPneumatic, Electric, Electronic };
#pragma option pop

#pragma option push -b-
enum TBrakeSubSystem { ss_None, ss_W, ss_K, ss_KK, ss_Hik, ss_ESt, ss_KE, ss_LSt, ss_MT };
#pragma option pop

#pragma option push -b-
enum TBrakeValve { W, W_Lu_VI, W_Lu_L, W_Lu_XR, K, Kg, Kp, Kss, Kkg, Kkp, Kks, Hikg1, Hikss, Hikp1, 
	KE1a, SW, ESt3, LSt, ESt4, EP1, EP2, M483, Other };
#pragma option pop

#pragma option push -b-
enum TBrakeHandle { NoHandle, West, FV4a, M394, M254, FVel1, FVel2, D2, Knorr, FD1 };
#pragma option pop
...
typedef double TBrakeDelayTable[5];
...
public:
	...
	void __fastcall ValveCheck(double dt);
	double __fastcall GetDVc(double dt);
	double __fastcall GetDVv(double dt);
	double __fastcall GetDVh(double dt);
	double __fastcall GetDVb(double dt);
...
static const Shortint bdelay_Mg = 0x8;
static const Byte bdelay_none = 0x80;
static const Shortint b_off = 0x0;
static const Shortint b_hold = 0x1;
...
static const Shortint el_oil = 0x0;
static const Shortint el_water = 0x1;
static const Shortint el_fuel = 0x2;
static const Shortint el_act = 0x0;
static const Shortint el_min = 0x1;
static const Shortint el_max = 0x2;
static const Shortint el_off = 0x3;
static const Shortint el_T = 0x0;
static const Shortint el_P = 0x1;
