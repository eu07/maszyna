...
// Q ADDONS
    ...
    TGauge VelocityGauge_q;
    TGauge TachoClockMIn_q;
    TGauge TachoClockHIn_q;
    TGauge ClockGaugeHou_q;
    TGauge ClockGaugeMin_q;
    TGauge ClockGaugeSec_q;

    TGauge Ventilator1_q;
    TGauge Ventilator2_q;
    ...
    TGauge piv_WycieraczkaR;          // QUEUEDEU 191008
    TGauge piv_WycieraczkaL;          // QUEUEDEU 191008
    TGauge piv_WycieraczkapR;
    TGauge piv_WycieraczkapL;
    TGauge piv_antysunL;              // QUEUEDEU 191008
    TGauge piv_antysunR;              // QUEUEDEU 191008
    TGauge piv_szafkaAL;              // QUEUEDEU 211008
    TGauge piv_szafkaAR;              // QUEUEDEU 211008
    TGauge piv_szafkaBATT;            // QUEUEDEU 211008
    TGauge piv_drzwi_maszynownia;     // QUEUEDEU 211008
    TGauge piv_drzwi_WN;              // QUEUEDEU 211008
    TGauge piv_stolikA;               // QUEUEDEU 091108
    TGauge piv_stolikB;               // QUEUEDEU 091108
    TGauge piv_nastawnikA;
    TGauge piv_nastawnikB;
    TGauge piv_drzwiAL;
    TGauge piv_drzwiAR;
    TGauge piv_drzwiBL;
    TGauge piv_drzwiBR;
    TGauge piv_mirrorAL;
    TGauge piv_mirrorAR;
    TGauge qbymano1;                  // QUEUEDEU 221008
    TGauge qbymano2;                  // QUEUEDEU 221008
    TGauge qbymano3;                  // QUEUEDEU 221008
    TGauge qbtampnn;                  // QUEUEDEU 221008
    TGauge qbtvolnn;                  // QUEUEDEU 221008
    TGauge qbtamps1;                  // QUEUEDEU 221008
    TGauge qbtamps2;                  // QUEUEDEU 221008
    TGauge qbtvoltr;                  // QUEUEDEU 221008
    TGauge qbttacho;                  // QUEUEDEU 221008
