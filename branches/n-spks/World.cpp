...
//        SetCursorPos(Global::iWindowWidth/2,Global::iWindowHeight/2);
   ...
   if ((Pressed(VK_RBUTTON)) || (Pressed(VK_F4)))
    ...
    {Ground.Update(dt,n);Ground.Update(dt,n);Ground.Update(dt,n);Ground.Update(dt,n);Ground.Update(dt,n);Ground.Update(dt,n);Ground.Update(dt,n);Ground.Update(dt,n);}        
    //blablabla
    //Sleep(50);
