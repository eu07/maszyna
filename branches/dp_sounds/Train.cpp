...
*/
//szum w czasie jazdy
//Wielepoziomowy Runningnoise - Szociu
...
{//wyciszenie dŸwiêków przy wychodzeniu
 ...
 rsSBHiss.Stop();
 rsRunningNoise[0].Stop();
 rsRunningNoise[1].Stop();
 rsRunningNoise[2].Stop();
 rsRunningNoise[3].Stop();
 rsRunningNoise[4].Stop();
 rsRunningNoise[5].Stop();
 rsRunningNoise[6].Stop();
 rsRunningNoise[7].Stop();
 rsRunningNoise[8].Stop();
 rsRunningNoise[9].Stop();
 rsRunningNoise[10].Stop();
 rsEngageSlippery.Stop();
 rsFadeSound.Stop();
