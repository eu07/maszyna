...
public:
 ...
 double Vmin;      //minimalna predkosc pojazdu przy jakiej odtwarzany jest dzwiek - Szociu
 double Vmax;      //maksymalna predkosc pojazdu przy jakiej odtwarzany jest dzwiek - Szociu
