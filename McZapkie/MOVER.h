...
static int const ctrain_depot =
    128; // nie roz³¹czalny podczas zwyk³ych manewrów (miêdzycz³onowy), we wpisie wartoœæ ujemna
...
struct TCurrentCollector
{
    ...
    double MinH;
    double MaxH; // zakres ruchu pantografu, nigdzie nie u¿ywany
    double CSW; // szerokoœæ czêœci roboczej (styku) œlizgacza
    double MinV;
    double MaxV; // minimalne i maksymalne akceptowane napiêcie
...
{ // Ra: wrapper na kod pascalowy, przejmuj¹cy jego funkcje  Q: 20160824 - juz nie wrapper a klasa
  // bazowa :)
  public:
    double dMoveLen;
    std::string filename;
